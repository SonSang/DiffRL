...
run_path = "./neurips2023_outputs/physics/results/ant"
gippo_path = "./neurips2023_outputs/physics/rebuttal/ant/gippo" # run_path + "/gippo"
...
with sns.axes_style("darkgrid"):
    ...
    # plt.show()
    plt.savefig("./rebuttal_learning_graph.pdf")
